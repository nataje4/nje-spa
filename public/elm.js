...
var $author$project$Main$view = function (model) {
	switch (model.$) {
		case 'Home':
			var home = model.a;
			return $author$project$Home$view(home);
		case 'Poetry':
			var poetry = model.a;
			return $author$project$Poetry$view(poetry);
		case 'Code':
			var code = model.a;
			return $author$project$Code$view(code);
		default:
			var error = model.a;
			return $author$project$Error$view(error);
	}
};
