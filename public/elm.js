...
{
	if (region.aY.ak === region.bb.ak)
	{
		return 'on line ' + region.aY.ak;
	}
	return 'on lines ' + region.aY.ak + ' through ' + region.bb.ak;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cK: 'hidden', cs: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cK: 'mozHidden', cs: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cK: 'msHidden', cs: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cK: 'webkitHidden', cs: 'webkitvisibilitychange' }
		: { cK: 'hidden', cs: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cG: fragment, bj: host, c6: path, bB: port_, bE: protocol, bF: query};
	});
...
var $author$project$Main$CodeDemos = function (a) {
	return {$: 7, a: a};
};
...
var $author$project$Code$initModel = function (flags) {
	return {aB: flags.aB, at: flags.at};
};
var $author$project$Code$Demos$initModel = function (flags) {
	return {aB: flags.aB, at: flags.at};
};
...
var $author$project$Home$initModel = function (flags) {
	return {aB: flags.aB, bq: false, at: flags.at};
};
var $author$project$Poetry$initModel = function (flags) {
	return {aB: flags.aB, at: flags.at};
};
var $author$project$Poetry$Erasure$EnterTextScreen = 0;
...
var $author$project$Poetry$Erasure$initModel = function (flags) {
	return {
		...
		F: '',
		T: 90,
		J: $elm$random$Random$initialSeed(42),
		V: 0,
		at: flags.at
	};
};
...
var $author$project$Poetry$WordBank$initModel = function (flags) {
	return {aB: flags.aB, aC: true, s: '', am: _List_Nil, at: flags.at, L: _List_Nil};
};
...
var $author$project$Main$routeChangeFlags = function (model) {
	return {
		aB: '',
		at: $author$project$Main$getWidth(model)
	};
};
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {O: frag, S: params, K: unvisited, B: value, Y: visited};
	});
...
var $author$project$Route$Code = 6;
var $author$project$Route$CodeDemos = 7;
var $author$project$Route$Home = 0;
var $author$project$Route$Poetry = 1;
var $author$project$Route$PoetryErasure = 5;
var $author$project$Route$PoetryEvents = 2;
var $author$project$Route$PoetryTools = 3;
var $author$project$Route$PoetryWordBank = 4;
	...
	return A2(
		...
		_Utils_update(
			url,
			{
				...
				c6: A2($elm$core$Maybe$withDefault, '', url.cG)
			}));
};
...
var $author$project$Poetry$Erasure$EraseWords = 1;
var $author$project$Poetry$Erasure$ClickableWord = F3(
	function (text, erased, position) {
		return {r: erased, an: position, ae: text};
	});
var $author$project$Poetry$Erasure$eraseOrBringBack = function (word) {
	var _v0 = word.r;
	if (_v0) {
		return A3($author$project$Poetry$Erasure$ClickableWord, word.ae, false, word.an);
	} else {
		return A3($author$project$Poetry$Erasure$ClickableWord, word.ae, true, word.an);
	}
};
...
var $author$project$Poetry$Erasure$totalNumberOfWords = function (model) {
	return $elm$core$List$length(model.g);
};
...
var $author$project$Poetry$Erasure$bringBackAWord = function (model) {
	...
	if (!broughtBackWord.$) {
		...
		return _Utils_update(
			...
			{
				g: newWords,
				J: $author$project$Poetry$Erasure$newSeed(model)
			});
	} else {
		return _Utils_update(
			model,
...
var $author$project$Poetry$Erasure$desiredAmountErased = function (model) {
	return (($author$project$Poetry$Erasure$totalNumberOfWords(model) * model.T) / 100) | 0;
};
...
var $author$project$Poetry$Erasure$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var word = msg.a;
				var newText = A3($elm_community$list_extra$List$Extra$updateAt, word.an - 1, $author$project$Poetry$Erasure$eraseOrBringBack, model.g);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{g: newText}),
			...
			case 1:
				var text = msg.a;
				var clickableText = $author$project$Poetry$Erasure$textToClickableWords(model.F);
				return $elm$core$String$isEmpty(model.F) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{g: clickableText, V: 1}),
					$elm$core$Platform$Cmd$none);
...
var $author$project$Poetry$WordBank$newPoemWord = F2(
	function (model, str) {
		return {
			aQ: A2($author$project$Poetry$WordBank$poemWordInWordBank, model, str),
			k: str
		};
	});
...
var $author$project$Poetry$WordBank$setToUnused = function (wbw) {
	return {ab: wbw.ab, X: false, k: wbw.k};
};
	...
	function (poemW, w0rdBank) {
		return $elm$core$List$head(
			A2(
				...
				function (w) {
					return _Utils_eq(
						$elm$core$String$toLower(w.k),
						$elm$core$String$toLower(poemW.k));
				},
				A2(
					$elm$core$List$filter,
					function (w) {
...
var $author$project$Poetry$WordBank$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				var str = msg.a;
				return $elm$core$String$isEmpty(model.s) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aC: false,
							s: '',
							L: $author$project$Poetry$WordBank$inputToWordBank(str)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				var str = msg.a;
				var resetWordBank = $author$project$Poetry$WordBank$setAllWordBankWordsToUnused(model.L);
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {b1: 'a', aG: 'atv', b3: 'ab', b4: 'cx', b5: 'cy', b6: 'acb', b7: 'accx', b8: 'accy', b9: 'acr', a2: 'al', a3: 'ar', ca: 'at', aH: 'ah', aI: 'av', cd: 's', ch: 'bh', ci: 'b', cj: 'w7', cl: 'bd', cm: 'bdt', au: 'bn', cn: 'bs', av: 'cpe', ct: 'cp', cu: 'cpx', cv: 'cpy', D: 'c', ax: 'ctr', ay: 'cb', az: 'ccx', E: 'ccy', aj: 'cl', aA: 'cr', cx: 'ct', cy: 'cptr', cz: 'ctxt', cF: 'fcs', bd: 'focus-within', cH: 'fs', cJ: 'g', aN: 'hbh', aO: 'hc', bh: 'he', aP: 'hf', bi: 'hfp', cL: 'hv', cN: 'ic', cP: 'fr', cR: 'iml', cS: 'imlf', cT: 'imlp', cU: 'implw', F: 'it', cV: 'i', bo: 'lnk', ac: 'nb', bs: 'notxt', c$: 'ol', c0: 'or', R: 'oq', c4: 'oh', bx: 'pg', by: 'p', c5: 'ppe', da: 'ui', v: 'r', dd: 'sb', de: 'sbx', df: 'sby', dg: 'sbt', dj: 'e', dk: 'cap', dm: 'sev', dt: 'sk', ae: 't', dx: 'tc', dy: 'w8', dz: 'w2', dA: 'w9', dB: 'tj', aF: 'tja', dC: 'tl', dD: 'w3', dE: 'w5', dF: 'w4', dG: 'tr', dH: 'w6', dI: 'w1', dJ: 'tun', bT: 'ts', W: 'clr', dO: 'u', a_: 'wc', bY: 'we', a$: 'wf', bZ: 'wfp', a0: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$Generic = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$div = $mdgriffith$elm_ui$Internal$Model$Generic;
var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.cd + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.D);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.cd + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cJ);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.cd + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bx);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.cd + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.by);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.cd + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.v);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.cd + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dj);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.x)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dn.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dn.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.v) + ('-' + ($elm$core$String$fromInt(pos.cw) + ('-' + ($elm$core$String$fromInt(pos.at) + ('-' + $elm$core$String$fromInt(pos.bg)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.bM) + 'px'),
					$elm$core$Maybe$Just(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.W)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.R)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cF, $mdgriffith$elm_ui$Internal$Style$classes.W)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cF, $mdgriffith$elm_ui$Internal$Style$classes.R)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aG, $mdgriffith$elm_ui$Internal$Style$classes.W)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aG, $mdgriffith$elm_ui$Internal$Style$classes.R)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cd) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.v) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cd) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cd) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.v) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cd) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ax) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aw: closing, i: _List_Nil, I: _List_Nil, A: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								i: A2(
									$elm$core$List$cons,
									{aw: '\n}', i: _List_Nil, I: props, A: '@supports (' + (prop + (':' + (value + (') {' + parent.A))))},
									rendered.i)
							});
					case 4:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.A + ('{' + (renderValues(rule.I) + (rule.aw + '}')));
		}
	};
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var single = '.' + $mdgriffith$elm_ui$Internal$Style$classes.dj;
				var row = '.' + $mdgriffith$elm_ui$Internal$Style$classes.v;
				var wrappedRow = '.' + ($mdgriffith$elm_ui$Internal$Style$classes.a0 + row);
				var right = '.' + $mdgriffith$elm_ui$Internal$Style$classes.a3;
				var paragraph = '.' + $mdgriffith$elm_ui$Internal$Style$classes.by;
				var page = '.' + $mdgriffith$elm_ui$Internal$Style$classes.bx;
				var left = '.' + $mdgriffith$elm_ui$Internal$Style$classes.a2;
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.v) + (' / ' + ($elm$core$String$fromInt(position.v + position.bg) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.cw) + (' / ' + ($elm$core$String$fromInt(position.cw + position.at) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.v) + ('-' + ($elm$core$String$fromInt(position.cw) + ('-' + ($elm$core$String$fromInt(position.at) + ('-' + $elm$core$String$fromInt(position.bg)))))));
...
var $mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(
	function (fontToAdjust, _v0, otherFontName) {
		...
		return A2(
			...
			' ',
			_Utils_ap(
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.dk, capital),
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.cH, full)));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dk + (', ' + ('.' + (name + (' .' + $mdgriffith$elm_ui$Internal$Style$classes.dk))))))),
					_List_fromArray(
						[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dk + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.ae + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.dk + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.ae)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bg: height / size, bM: size, bW: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cr, adjustment.cg, adjustment.cA, adjustment.cX]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.cd + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dj))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cd, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.ax, $mdgriffith$elm_ui$Internal$Style$classes.E, $mdgriffith$elm_ui$Internal$Style$classes.b9])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cd, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.ax, $mdgriffith$elm_ui$Internal$Style$classes.E, $mdgriffith$elm_ui$Internal$Style$classes.b7])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cd, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.ax, $mdgriffith$elm_ui$Internal$Style$classes.b8])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cd, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.ax, $mdgriffith$elm_ui$Internal$Style$classes.b6])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.cd + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ae + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aO)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.cd + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ae + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aP)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ac, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.b1]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ac, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.ci]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ac, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.c0]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ac, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.c$]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ac, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.cP]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ac, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.ch]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aH + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a3);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aH + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b4);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aI + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ca);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aI + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b3);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aI + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b5);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.cd + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.D + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.cd + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.v + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								...
								case 2:
									var portion = width.a;
									if (portion === 1) {
										var $temp$classes = classes + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a$),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cx + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aj)),
				A2(
					$elm$core$List$cons,
...
var $author$project$ViewHelpers$noPadding = {ai: 0, cW: 0, c9: 0, bR: 0};
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aj + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.E)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{cF: $elm$core$Maybe$Nothing, cL: $elm$core$Maybe$Nothing, cZ: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.da, $mdgriffith$elm_ui$Internal$Style$classes.cd, $mdgriffith$elm_ui$Internal$Style$classes.dj]))),
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.az + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.E + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bo)))),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
					...
					A2(
						...
						_Utils_ap(
							...
							_Utils_ap(
								elements,
								_List_fromArray(
									[$author$project$ViewHelpers$footer])))))
				]),
			bQ: title
		};
	});
var $author$project$ViewHelpers$ExtraLarge = 3;
var $author$project$ViewHelpers$Large = 2;
var $author$project$ViewHelpers$Medium = 1;
var $author$project$ViewHelpers$Small = 0;
var $author$project$ViewHelpers$findScreenSize = function (width) {
	return (width <= 450) ? 0 : ((width <= 800) ? 1 : ((width <= 1200) ? 2 : 3));
};
...
var $mdgriffith$elm_ui$Element$Font$bold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.cj);
...
var $author$project$ViewHelpers$subtitleStyle = _List_fromArray(
	[
		$author$project$ViewHelpers$mainFonts,
		$mdgriffith$elm_ui$Element$Font$center,
...
var $author$project$ViewHelpers$emailLink = function (email) {
...
var $author$project$Code$subtitleText = _List_fromArray(
	[
		...
		$author$project$ViewHelpers$linkStyle,
		{
			bn: $mdgriffith$elm_ui$Element$text('elm-ui'),
			bU: 'https://package.elm-lang.org/packages/mdgriffith/elm-ui/latest'
		}),
		$mdgriffith$elm_ui$Element$text(' package.) You can contact her with programming-related inquiries at '),
		$author$project$ViewHelpers$emailLink('code@nataliejaneedson.com'),
		$mdgriffith$elm_ui$Element$text(' or find her on twitter '),
		A2(
		$mdgriffith$elm_ui$Element$link,
		$author$project$ViewHelpers$linkStyle,
		{
			bn: $mdgriffith$elm_ui$Element$text('@nataje4'),
			bU: 'https://www.twitter.com/nataje4'
		}),
		$mdgriffith$elm_ui$Element$text('.')
	]);
...
var $author$project$ViewHelpers$titleStyle = _List_fromArray(
	[
		$author$project$ViewHelpers$emphasisFonts,
		$mdgriffith$elm_ui$Element$Font$center,
...
var $author$project$Code$view = function (model) {
	...
	var screenSize = $author$project$ViewHelpers$findScreenSize(model.at);
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text('CODE DEMOS')
									])),
								A2(
								$mdgriffith$elm_ui$Element$paragraph,
...
var $mdgriffith$elm_ui$Element$Font$italic = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cV);
var $author$project$Poetry$subtitleText = _List_fromArray(
	[
		...
		$author$project$ViewHelpers$linkStyle,
		{
			bn: $mdgriffith$elm_ui$Element$text('@nataliejedson'),
			bU: 'https://www.twitter.com/nataliejedson'
		}),
		$mdgriffith$elm_ui$Element$text('.')
	]);
...
var $author$project$Poetry$view = function (model) {
	var viewHelper = $author$project$ViewHelpers$documentMsgHelper('NJE: POETRY');
...
var $author$project$Poetry$Erasure$displayClickableWord = function (word) {
	return A2(
		...
		$mdgriffith$elm_ui$Element$text(word.ae + ' '));
};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.az + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.E + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bs)))))),
						A2(
							$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {ai: -box.ai, cW: -box.cW, c9: -box.c9, bR: -box.bR};
};
					...
					case 7:
						...
						if (isMultiline) {
							...
							var reducedVerticalPadding = $mdgriffith$elm_ui$Element$paddingEach(
								{
									ai: b - A2($elm$core$Basics$min, t, b),
									cW: l,
									c9: r,
									bR: t - A2($elm$core$Basics$min, t, b)
								});
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			...
			A3(
				...
				{m: _List_Nil, b: _List_Nil, s: _List_Nil, a: _List_Nil, ag: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.bs + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c5)),
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$Attr(
							$elm$html$Html$Events$onInput(textOptions.bu)),
											...
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.cS)
															]),
														_List_fromArray(
															[
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.m, textOptions.ae === ''))
												]);
										}
									}()
									])))),
...
var $mdgriffith$elm_ui$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			...
			{q: $elm$core$Maybe$Nothing, w: multi.$7, j: $mdgriffith$elm_ui$Element$Input$TextArea},
			attrs,
			{bn: multi.bn, bu: multi.bu, bA: multi.bA, ae: multi.ae});
	});
				...
				_List_fromArray(
					[
							...
							]),
						{
							...
							bu: $author$project$Poetry$Erasure$UpdateInputText,
						...
						A2(
							...
							$author$project$ViewHelpers$buttonStyle(
								$elm$core$String$isEmpty(model.F)),
							{
								bn: $mdgriffith$elm_ui$Element$text('ENTER'),
								al: $elm$core$Maybe$Just(
									$author$project$Poetry$Erasure$MakeTextClickable(model.F))
							}))
					]))
			]));
};
...
var $author$project$Poetry$Erasure$displayPercentRandomInput = function (model) {
	return A2(
			...
			]),
		{
			...
			bu: $author$project$Poetry$Erasure$UpdatePercentRandom,
			bA: $elm$core$Maybe$Nothing,
			ae: $elm$core$String$fromInt(model.T)
		});
};
var $author$project$Poetry$Erasure$Randomize = {$: 3};
var $author$project$Poetry$Erasure$displayRandomizeButton = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		$author$project$ViewHelpers$buttonStyle(!model.T),
		{
			bn: $mdgriffith$elm_ui$Element$text('RANDOMIZE'),
			al: $elm$core$Maybe$Just($author$project$Poetry$Erasure$Randomize)
		});
};
var $author$project$Poetry$Erasure$UpdateSubPage = function (a) {
	return {$: 6, a: a};
};
var $author$project$Poetry$Erasure$displayResetButton = function (model) {
	return A2(
		...
		{
			bn: $mdgriffith$elm_ui$Element$text('RESET TEXT'),
			al: $elm$core$Maybe$Just(
				$author$project$Poetry$Erasure$UpdateSubPage(0))
		});
};
var $author$project$Poetry$Erasure$PreviewPoemText = 2;
var $author$project$Poetry$Erasure$displayTogglePreviewTextButton = function (model) {
	...
	if (_v0 === 1) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			$author$project$ViewHelpers$buttonStyle(
				$elm$core$List$isEmpty(selectedWords)),
			{
				bn: $mdgriffith$elm_ui$Element$text('PREVIEW POEM TEXT'),
				al: $elm$core$Maybe$Just(
					$author$project$Poetry$Erasure$UpdateSubPage(2))
			});
	} else {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			$author$project$ViewHelpers$buttonStyle(
				$elm$core$List$isEmpty(selectedWords)),
			{
				bn: $mdgriffith$elm_ui$Element$text('GO BACK'),
				al: $elm$core$Maybe$Just(
					$author$project$Poetry$Erasure$UpdateSubPage(1))
			});
	}
};
var $author$project$Poetry$Erasure$displayBody = function (model) {
	return (!model.V) ? _List_fromArray(
		[
			$author$project$Poetry$Erasure$displayEnterTextScreen(model)
		]) : ((model.V === 1) ? _List_fromArray(
		[
			A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Poetry$Erasure$displayTogglePreviewTextButton(model)
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$row,
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$paragraph,
							_List_Nil,
							A2($elm$core$List$map, $author$project$Poetry$Erasure$displayClickableWord, model.g))
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$row,
				...
				[
					...
					_List_fromArray(
						[
							...
							A2(
								$elm$core$List$map,
								$author$project$Poetry$Erasure$displayClickableWord,
								A2(
									$elm$core$List$filter,
									function (x) {
										return !x.r;
...
var $author$project$Poetry$Erasure$view = function (model) {
	return A4(
		...
		$author$project$ViewHelpers$findScreenSize(model.at),
		'ERASURE',
		'',
...
var $author$project$Poetry$WordBank$displayCreateWordBankButton = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		$author$project$ViewHelpers$buttonStyle(
			$elm$core$String$isEmpty(model.s)),
		{
			bn: $mdgriffith$elm_ui$Element$text('ENTER'),
			al: $elm$core$Maybe$Just(
				$author$project$Poetry$WordBank$CreateWordBank(model.s))
		});
};
var $author$project$Poetry$WordBank$UpdatePoemInput = function (a) {
	return {$: 2, a: a};
};
var $author$project$Poetry$WordBank$Reset = {$: 3};
var $author$project$Poetry$WordBank$displayResetButton = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		$author$project$ViewHelpers$buttonStyle(false),
		{
			bn: $mdgriffith$elm_ui$Element$text('RESET'),
			al: $elm$core$Maybe$Just($author$project$Poetry$WordBank$Reset)
		});
};
				...
				_List_fromArray(
					[
						...
						_List_Nil,
						{
							...
							bu: $author$project$Poetry$WordBank$UpdatePoemInput,
							bA: $elm$core$Maybe$Nothing,
							$7: false,
							ae: model.s
						})
			...
			[
				...
				_List_Nil,
				{
					bn: A2(
						...
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('Input source text here:')),
					bu: $author$project$Poetry$WordBank$UpdateWordBankInput,
					bA: $elm$core$Maybe$Nothing,
					$7: false,
					ae: model.s
				})
...
var $author$project$Poetry$WordBank$displayExtraPoemWord = function (poemW) {
	return A2(
		...
		$mdgriffith$elm_ui$Element$text(poemW.k + ' '));
};
...
var $author$project$Poetry$WordBank$displayWordBankWord = function (wbWord) {
	return wbWord.X ? A2(
		...
		$mdgriffith$elm_ui$Element$text(wbWord.k + ' ')) : A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color($author$project$ViewHelpers$black),
		...
		$mdgriffith$elm_ui$Element$text(wbWord.k + ' '));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$paragraph,
				_List_Nil,
				A2($elm$core$List$map, $author$project$Poetry$WordBank$displayWordBankWord, model.L))
			]));
};
...
var $author$project$Poetry$WordBank$displayBody = function (model) {
	return model.aC ? _List_fromArray(
		[
		...
		]) : ((($author$project$ViewHelpers$findScreenSize(model.at) === 2) || ($author$project$ViewHelpers$findScreenSize(model.at) === 3)) ? _List_fromArray(
		[
			A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
...
var $author$project$Main$view = function (model) {
	...
	switch (model.$) {
		...
		case 7:
			var mod3l = model.a;
			return $author$project$Code$Demos$view(mod3l);
		default:
			var mod3l = model.a;
			return $author$project$Error$view(mod3l);
	}
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{cQ: $author$project$Main$init, c1: $author$project$Main$ChangedUrl, c2: $author$project$Main$ClickedLink, dv: $author$project$Main$subscriptions, dP: $author$project$Main$update, dQ: $author$project$Main$view});
