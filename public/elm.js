...
var $author$project$ViewHelpers$emailLink = F2(
	function (text_, email) {
...
var $author$project$Code$subtitleText = _List_fromArray(
	[
		...
		A2($author$project$ViewHelpers$emailLink, 'here', 'code@nataliejaneedson.com'),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[$mdgriffith$elm_ui$Element$none])),
										A5($author$project$ViewHelpers$pictureLink, 'https://www.github.com/nataje4', 'assets/blackcattyping2.png', 'click here to go to my github page', 'GITHUB', 1),
										A5($author$project$ViewHelpers$pictureLink, '#', 'assets/blackcattyping2.png', 'click here to see some samples of my work', 'DEMOS', 1),
										A5($author$project$ViewHelpers$pictureLink, '#', 'assets/blackcattyping2.png', 'click here to view the latest version of my resume', 'RESUME', 1),
										A2(
										$mdgriffith$elm_ui$Element$column,
										_List_fromArray(
											[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A5($author$project$ViewHelpers$pictureLink, 'https://www.github.com/nataje4', 'assets/blackcattyping2.png', 'click here to bgo to my github page', 'GITHUB', 1)
									])),
								A2(
								$mdgriffith$elm_ui$Element$row,
								_List_fromArray(
								...
								_List_fromArray(
									[
										A5($author$project$ViewHelpers$pictureLink, '#', 'assets/blackcattyping2.png', 'click here to see asome samples of my work', 'DEMOS', 1)
									])),
								A2(
								$mdgriffith$elm_ui$Element$row,
								_List_fromArray(
...
var $author$project$ViewHelpers$bodyEl = function (textElements) {
	return A2(
		$mdgriffith$elm_ui$Element$textColumn,
		_List_fromArray(
			[
...
var $author$project$ViewHelpers$markdownPageHelper = F3(
	function (screenSize, title, markdownString) {
		var markdownElement = $mdgriffith$elm_ui$Element$html(
			A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$ViewHelpers$bodyEl(
									_List_fromArray(
										[markdownElement])),
									$author$project$ViewHelpers$bodySideSpacer(screenSize)
								]))
...
var $author$project$Poetry$subtitleText = _List_fromArray(
	[
		...
		A2($author$project$ViewHelpers$emailLink, 'here', 'poetry@nataliejaneedson.com'),
		$mdgriffith$elm_ui$Element$text(' or find her on twitter '),
		A2(
		$mdgriffith$elm_ui$Element$link,
		$author$project$ViewHelpers$linkStyle,
...
var $author$project$Poetry$Events$markdownString = '\n    # Illi hos tantum templo\n\n    ## Ut ter inquit interdum modo tenendae aestus\n\n    Lorem markdownum arcum Philomela pectine, est portans angulus utque diem, non.\n    Primi infamia auctor Adoni. Per leto circumdata ipsa vigilat, tamen omnique\n    procul sagittis lumen, orbi.\n\n    - Pro totumque protinus in aegra hasta\n    - Apro quamvis\n    - Ulla ibat mortis caligine discors harenis habuissem\n    - Temeraria balatus\n    - Voce Pasiphaen vidit\n\n    ## Ex sextae deae pro quid novissima quoque\n\n    Antiphatae in Achivi suam inplevit, credula sub ferro aliquid increpor ast orbae\n    delendaque, flenda memor inque inputet opaca. Fallere segnior et oculis umbra;\n    iactant fera vulnera quisque Pelasgi aestus vagae, Neptunus sed. Et quicquam\n    uritur: pro quae: curvo creatus nec quae. Est postes de rura, peperisse est a\n    aliquisque, niveae ademptae dabantur hippomene matremque. Laborem est morte, et\n    vidit: parva in altera gener, unum quam ab ursos montibus nunc!\n\n    Stellantibus dixit incinctus cum amore denique; et etiam meliore inducit cum\n    auras fama nunc! Dedit en apta exstabat Alcmene secundum; verumque miserrima\n    fecerat, concipit iram siqua, neve? Herba praevisos, ecce Procne a aures fames\n    fumida in nocuit latentem matri.\n\n    ## Caelestesque sedare est pereunt undis\n\n    Umbram ille arida monstro et carmine indice, languere nulla mihi deo elisarum\n    quid mellaque iacent, mihi. Quamvis tu inrequieta Clanis experientis omnia,\n    matri conspectos medios urguet flecti simul! Venenis ripas in genitor pars, et\n    levavit mi vultus plebe interceperit verba dissaepserat Cephalum. Dixit me onus\n    video duorum, suo equis ignibus lapsa regia corpore e vestrae usus dedecus.\n\n    Permiscuit atque corripuit et teque putando collo minari natura ornata\n    penetralia in procul Iove. Non ora, effudit turpe gemitus recentibus atria\n    meminisse extinctum Scyllae et dextera resolvit tamen urbes. Cipus figuras.\n    ';
var $author$project$Poetry$Events$view = function (model) {
	return A3(
		$author$project$ViewHelpers$markdownPageHelper,
		$author$project$ViewHelpers$findScreenSize(model.width),
		'POETRY EVENTS',
		$author$project$Poetry$Events$markdownString);
};
var $author$project$Poetry$Tools$markdownString = '\n    # Illi hos tantum templo\n\n    ## Ut ter inquit interdum modo tenendae aestus\n\n    Lorem markdownum arcum Philomela pectine, est portans angulus utque diem, non.\n    Primi infamia auctor Adoni. Per leto circumdata ipsa vigilat, tamen omnique\n    procul sagittis lumen, orbi.\n\n    - Pro totumque protinus in aegra hasta\n    - Apro quamvis\n    - Ulla ibat mortis caligine discors harenis habuissem\n    - Temeraria balatus\n    - Voce Pasiphaen vidit\n\n    ## Ex sextae deae pro quid novissima quoque\n\n    Antiphatae in Achivi suam inplevit, credula sub ferro aliquid increpor ast orbae\n    delendaque, flenda memor inque inputet opaca. Fallere segnior et oculis umbra;\n    iactant fera vulnera quisque Pelasgi aestus vagae, Neptunus sed. Et quicquam\n    uritur: pro quae: curvo creatus nec quae. Est postes de rura, peperisse est a\n    aliquisque, niveae ademptae dabantur hippomene matremque. Laborem est morte, et\n    vidit: parva in altera gener, unum quam ab ursos montibus nunc!\n\n    Stellantibus dixit incinctus cum amore denique; et etiam meliore inducit cum\n    auras fama nunc! Dedit en apta exstabat Alcmene secundum; verumque miserrima\n    fecerat, concipit iram siqua, neve? Herba praevisos, ecce Procne a aures fames\n    fumida in nocuit latentem matri.\n\n    ## Caelestesque sedare est pereunt undis\n\n    Umbram ille arida monstro et carmine indice, languere nulla mihi deo elisarum\n    quid mellaque iacent, mihi. Quamvis tu inrequieta Clanis experientis omnia,\n    matri conspectos medios urguet flecti simul! Venenis ripas in genitor pars, et\n    levavit mi vultus plebe interceperit verba dissaepserat Cephalum. Dixit me onus\n    video duorum, suo equis ignibus lapsa regia corpore e vestrae usus dedecus.\n\n    Permiscuit atque corripuit et teque putando collo minari natura ornata\n    penetralia in procul Iove. Non ora, effudit turpe gemitus recentibus atria\n    meminisse extinctum Scyllae et dextera resolvit tamen urbes. Cipus figuras.\n    ';
var $author$project$Poetry$Tools$view = function (model) {
	return A3(
		$author$project$ViewHelpers$markdownPageHelper,
		$author$project$ViewHelpers$findScreenSize(model.width),
		'POETRY TOOLS',
		$author$project$Poetry$Tools$markdownString);
};
