...
var $author$project$Main$Err = {$: 'Err'};
var $author$project$Main$routeToModel = function (maybeRoute) {
	if (maybeRoute.$ === 'Just') {
		...
		return $author$project$Main$Err;
	}
};
...
var $author$project$ViewHelpers$pictureLink = F4(
	function (perRowClass, linkString, imgSrc, text_) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('picture-link'),
					$elm$html$Html$Attributes$class(perRowClass)
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$class('square-image')
								]),
							_List_Nil),
							A2(
							$elm$html$Html$span,
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('bottom-text')
								]),
							_List_fromArray(
								[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('NATALIE JANE EDSON')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('is a poet, programmer, and aspiring polymath based in Portland, OR. She has a lot to say about her work—what do you want to know about?')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('\n                            Natalie\'s written work focuses on mental health, love, and the mundane. \n                            She is also interested in the intersection of code and poetry and has written \n                            a number of tools to assist in her personal generative writing practice, all of \n                            which will be available on this website soon. In the meantime, her erasure tool \n                            can be found                            \n                        ')
									]))
							]))
					]))
			]),
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('ERROR PAGE NOT FOUND')
									]))
							]))
					]),
				title: 'NJE: ERROR'
