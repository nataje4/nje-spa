...
var $author$project$ViewHelpers$titleSideSpacer = A2(
	...
	_List_fromArray(
		[$mdgriffith$elm_ui$Element$none]));
var $author$project$ViewHelpers$basicLayoutHelper = F3(
	function (screenSize, title, bodyRows) {
...
var $author$project$Poetry$WordBank$extraWordColor = A3($mdgriffith$elm_ui$Element$rgb, 93.0, 153.0, 186.0);
...
var $author$project$ViewHelpers$lightGrey = A3($mdgriffith$elm_ui$Element$rgb, 180.0, 180.0, 180.0);
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Poetry.Erasure.ClickableWord":{"args":[],"type":"{ text : String.String, erased : Basics.Bool, position : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ChangedUrl":["Url.Url"],"ClickedLink":["Browser.UrlRequest"],"ResizeWindow":["Basics.Int","Basics.Int"],"GotErasureMsg":["Poetry.Erasure.Msg"],"GotWordBankMsg":["Poetry.WordBank.Msg"],"GotPoetryMsg":["Poetry.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Poetry.Msg":{"args":[],"tags":{"NoOp":[]}},"Poetry.Erasure.Msg":{"args":[],"tags":{"ToggleWord":["Poetry.Erasure.ClickableWord"],"MakeTextClickable":["String.String"],"UpdateInputText":["String.String"],"GoBackToTextEntry":[],"Randomize":[],"UpdatePercentRandom":["String.String"],"GetSeed":["Maybe.Maybe Time.Posix"]}},"Poetry.WordBank.Msg":{"args":[],"tags":{"UpdateWordBankInput":["String.String"],"CreateWordBank":["String.String"],"UpdatePoemInput":["String.String"],"Reset":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}}}}})}});}(this));